...
public class AdapterCreateAssignment {
    String a1_assignmentTitle, a2_assignmentDetails;

    public AdapterCreateAssignment() {
    }

    public AdapterCreateAssignment(String a1_assignmentTitle, String a2_assignmentDetails) {
